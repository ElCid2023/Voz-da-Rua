...
function getCoordinatesFromLocation(localizacao, reclamacao = null) {
    ...
    if (localizacao) {
        ...
        // Coordenadas exatas por CEP/bairro - CORRIGIDAS PARA MESMA REGIÃO
        const coordenadasExatasPorRegiao = {
            // Todos os CEPs 08330-xxx ficam na MESMA região (Jardim Ester/Vila Ester)
            '08330-310': [-23.619619448198613, -46.466918235362044], // Jardim Ester - coordenadas exatas
            '08330-260': [-23.619519448198613, -46.466818235362044], // Vila Ester - muito próximo
            '08330-000': [-23.619619448198613, -46.466918235362044], // São Rafael - mesma área
            'jardim ester': [-23.619619448198613, -46.466918235362044],
            'vila ester': [-23.619519448198613, -46.466818235362044],
            'são rafael': [-23.619619448198613, -46.466918235362044],
            'sao rafael': [-23.619619448198613, -46.466918235362044],
            
            // CEP 08340-000 - São Mateus (mais distante)
